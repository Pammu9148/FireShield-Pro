          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-4 bg-primary-600 text-white rounded-lg font-semibold hover:bg-primary-700 transition-colors flex items-center justify-center"
                >
            ...
            <div>
              ...
              <div className="mt-8 bg-primary-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <button className="w-full px-4 py-3 bg-white text-gray-700 rounded-lg hover:bg-gray-100 transition-colors text-left flex items-center justify-between">
